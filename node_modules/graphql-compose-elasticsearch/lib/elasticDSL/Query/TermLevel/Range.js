...
function getRangeITC() {
  ...
  var name = (0, _utils.getTypeName)('QueryRange', opts);
  ...
  var subName = (0, _utils.getTypeName)('QueryRangeSettings', opts);
  var fields = (0, _FieldNames.getAllAsFieldConfigMap)(opts, (0, _utils.getOrSetType)(subName, function () {
